...
![image](https://github.com/user-attachments/assets/dfc02b83-47b6-4e0b-91d5-632001af2bc8)
ในช่วงแรกเราได้ทำการ break point ที่ int a = 1 แล้ว Debug ผลลัพธ์ก้แสดงออกมาเป็น a=0,b=0,c=0 แต่พอเรากด Step Over ที่แสดงจะเป็น a=1,b=0,c=0 
...
- การรันคำสั่ง Start Without Debugging ให้ผลเหมือนหรือต่างจากการ debug
  การรันคำสั่งทั้ง2 ให้ผลลัพธ์ที่แสดงเหมือนกัน
