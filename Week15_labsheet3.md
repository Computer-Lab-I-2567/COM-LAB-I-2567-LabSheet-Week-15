...
19. ให้ debug โปรแกรมจนจบ บันทึกสิ่งที่ได้ในแต่ละขั้น
    ![image](https://github.com/user-attachments/assets/2387918d-5f5b-468e-9623-69f1bf145cdd)
    ตอนแรกที่ดีบัค ขึ้น a=2,b=3,c=0 พอกดF11 ขึ้น  a=2,b=3 c หายไป และกดF11 ไปเรื่อยๆจนบรรทัดที่ 9 ก็วนที่ a=2,b=3,c=0
 จนบรรทัดที่ 10  a=2,b=3,c=5 cเปลี่ยนค่าเป็น 5 และจบโปรแกรม
